...
import { ArrowLeft, Settings2, Mic, Database as DatabaseIcon, SparkleIcon, Radio } from 'lucide-react';
...
import { AsrServiceSettings } from '@/components/AsrServiceSettings';
...
const TABS = [
  ...
  { value: 'liveAsr', label: 'Live ASR', icon: Radio },
